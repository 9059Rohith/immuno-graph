      ...
      operation: (validated) => ({
        observations: predictSyntheticBinding(validated).map((observation) => ({
          ...
          rawFields: {
            ...
            modelFamily: 'deterministic dual-head demonstration scorer',
            mlModel: 'immunograph-deterministic-linear-demo-head@1.0.0',
            dlModel: 'immunograph-deterministic-nonlinear-demo-head@1.0.0',
            modelScores: observation.modelScores,
